...
struct GameView: View {
    @StateObject var viewModel: GameViewModel
    @StateObject var rankingViewModel: RankingViewModel  // เพิ่มตัวแปรนี้
    
    init(viewModel: @autoclosure @escaping () -> GameViewModel = GameViewModel(), rankingViewModel: @autoclosure @escaping () -> RankingViewModel = RankingViewModel()) {
        _viewModel = StateObject(wrappedValue: viewModel())
        _rankingViewModel = StateObject(wrappedValue: rankingViewModel())  // ส่งค่าตัวแปรนี้
    }
    ...
    var body: some View {
        ...
        .sheet(isPresented: $viewModel.showSuccessScreen) {
                    SuccessView(
                        ...
                        rankingViewModel: rankingViewModel // ✅ เพิ่มพารามิเตอร์
                    )
                }
